...
function App() {
  ...
  const circle = require('../src/assets/images/yellow-circle.png');
  ...
  const MyDocument = () => {
      ...
      let image = require('../src/assets/images/5903.a.jpg')
                                  ...
                                  <div className='row'>
                                      <div className="row">
                                          ...
                                          <div className="col-md-5 p-0">
                                              <div className='template-text-heading'>Heading</div>
                                              <div className='template-text-sub-heading'>Title</div>
                                          </div>
                                          <div className="col-md-5 p-0">
